class TFirebaseException implements Exception{
  ...
  String get message{
    switch (code){
      case"unknown":
        return'An unknow firebase error occured. Please try again';
      ...
      case "email-already-in-use":
        return 'The email address provided is already registerd. Please use a different email';
      case"wrong-password":
      ...
      case'captcha-check-failed':
        return'The reCaptcha resonse is invalid. Please try again.';
      ...
      case 'app-deleted':
        return 'This instances of FirebaseApp has been deleted.';
      case 'user-token-mismatch':
        return'The provided user\'s token has a mismatch with the authentication user\'s user ID';
      ...
      case 'missing-action-code':
        return 'The action code is missing. Please provide a valid actoin code.';
